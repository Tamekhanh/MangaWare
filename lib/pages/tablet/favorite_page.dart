...
import 'package:manga_reading_ware/pages/tablet/manga_page.dart';

class FavoritePage extends StatefulWidget {
  final int width;

  const FavoritePage({super.key, required this.width});
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: widget.width == 1 ? 3 : widget.width == 2 ? 4 : 5,
